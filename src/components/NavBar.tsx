...
const Navbar: React.FC<{ refs: Record<string, React.RefObject<HTMLElement | null>> }> = ({ refs }) => {
  ...
  const socialLinks = [
    { href: "https://github.com/tarunsilam07", icon: <FaGithub size={25} className="text-white hover:text-gray-400" />, label: "GitHub" },
    { href: "https://www.linkedin.com/in/tarun-silam-83a46021a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", icon: <FaLinkedin size={25} className="text-blue-500 hover:text-blue-400" />, label: "LinkedIn" },
    { href: "https://www.instagram.com/tarun_077__?igsh=YjVwYTF3azBvZDR2", icon: <FaInstagram size={25} className="text-pink-500 hover:text-pink-400" />, label: "Instagram" },
  ];
